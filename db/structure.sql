...
CREATE TABLE `lesaintbreuvage`.`biere` ( `BIE_CodeBiere` VARCHAR(3) NOT NULL , `BIE_DesignationBiere` VARCHAR(20) NOT NULL , `BIE_DescriptionBiere` VARCHAR(150) NOT NULL , `BIE_LienImageBiere` VARCHAR(100) NOT NULL , `CAT_CodeCategorieBiere` VARCHAR(3) NOT NULL ) ENGINE = InnoDB;

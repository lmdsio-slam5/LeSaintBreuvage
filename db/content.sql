...
INSERT INTO `biere` (`BIE_CodeBiere`, `BIE_DesignationBiere`, `BIE_DescriptionBiere`, `BIE_LienImageBiere`, `CAT_CodeCategorieBiere`, `BIE_Degre`) VALUES ('GBA', 'Grimbergen Blanche', 'La Grim qui vous régalera pour l''été, idéale par journées ensoleillées ! ', 'GrimbergenBlanche', 'BLC', '6'), ('BF1', 'Blanche Foudroyante', 'Une Grande Réserve blanche étonnante aux saveurs douces et rafraîchissantes ! ', 'BlancheFoudroyante', 'BLC', '5');
INSERT INTO `prix` (`QUA_CodeQuantite`, `BIE_CodeBiere`, `PRX_Prix`) VALUES ('B33', 'GBA', '1.60'), ('B25', 'BF1', '1.60');
INSERT INTO `biere` (`BIE_CodeBiere`, `BIE_DesignationBiere`, `BIE_DescriptionBiere`, `BIE_LienImageBiere`, `CAT_CodeCategorieBiere`, `BIE_Degre`) VALUES ('CBL', 'Chimay Bleue', 'Une bière belge  trappiste brune fruitée et millésimée, elle peut vieillir en cave ! ', 'ChimayBleue', 'BRU', '9'), ('RB6', 'Rochefort 6', 'Une des 3 bières trappistes de l''Abbaye de Rochefort !  ', 'Rochefort6', 'BRU', '7.5');
INSERT INTO `prix` (`QUA_CodeQuantite`, `BIE_CodeBiere`, `PRX_Prix`) VALUES ('B33', 'CBL', '2.90'), ('B33', 'RB6', '2.30');
INSERT INTO `biere` (`BIE_CodeBiere`, `BIE_DesignationBiere`, `BIE_DescriptionBiere`, `BIE_LienImageBiere`, `CAT_CodeCategorieBiere`, `BIE_Degre`) VALUES ('EDM', 'Elav Dark Metal', 'Un Imperial Stout qui fera trembler les plus courageux d''entre vous ! ', 'ElavDarkMetal', 'NOI', '8.5'), ('YBB', 'Yellow Belly Stout', 'Une Imperial stout étonnante brassée par la brasserie Buxton en collaboration avec Omnipollo. ', 'YellowBellyStout', 'NOI', '11');